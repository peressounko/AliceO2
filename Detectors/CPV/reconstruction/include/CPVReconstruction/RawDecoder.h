...
namespace cpv
{
  ...
  class RawDecoderError{
    ...
    RawDecoderError(short l, short r, short d, short p, RawErrorType_t e):
          Ddl(l),Row(r),Dilogic(d),Pad(p),errortype(e){}
    RawDecoderError(const RawDecoderError &e):
          Ddl(e.Ddl),Row(e.Row),Dilogic(e.Dilogic),Pad(e.Pad),errortype(e.errortype){}
