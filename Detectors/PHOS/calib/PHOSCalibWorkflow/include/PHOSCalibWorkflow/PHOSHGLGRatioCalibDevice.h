...
class PHOSHGLGRatioCalibDevice : public o2::framework::Task
{
 ...
 public:
  explicit PHOSHGLGRatioCalibDevice(bool useCCDB) : mUseCCDB(useCCDB) {}
 ...
 private:
  ...
  CalibParams *mCalibObject=nullptr ;     /// Final calibration object
  TH2F *mhRatio = nullptr ;              /// Histogram with ratios
  ClassDefNV(PHOSHGLGRatioCalibDevice, 1);
};

DataProcessorSpec getHGLGRatioCalibSpec(bool useCCDB);
